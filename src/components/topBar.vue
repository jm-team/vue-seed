<template>
    <div class="yzk-header">
            ...
            <div class="layout-wrap">
                <div class="user-nav">
                    ...
                    <p class="user-info" v-else>
                        <span class="headpic"><img :src="userInfo.headImg | imgCdn" errorimg="../assets/img/headGray.png" onerror="this.src = this.getAttribute('errorimg')"></span>
                        <ul>
                            <li>
                                <p>{{ userInfo.nickName || userInfo.userName || '&nbsp;&nbsp;' }}</p>
                                <ul>
                                    <li><a :href="CENTER_ADDRESS+'/jttoverview/init'" target="_blank">个人中心</a></li>
                                    <li><a :href="USERCENTER_ADDRESS+'/logout?returnUrl=' + curPageUrl" @click="setUserIsLoginCookie">退出</a></li>
                                </ul>
                            </li>
                        </ul>
                    </p>
        ...
        <div class="top-head">
            <div class="layout-wrap">
                ...
                <div class="business-btn">
                    ...
                    <p>
                        <router-link :to="{ path: '/releaseResearch', query: {}}">邀请专家调研企业<span>Apply for expert's research on my company</span></router-link>
                    </p>
                </div>
            </div>
        </div>
        ...
        <el-dialog class="yzk-login" v-model="loginDialogShow" size="360px" @close="closeLoginDialog" @open="openLoginDialogCallback">
            <p class="login-title">欢迎登录</p>
            <el-form :model="loginForm" :rules="loginFormVerifyRule" ref="loginForm" label-width="1px">
                <el-form-item prop="username">
                    <el-input type="text" v-model="loginForm.username" auto-complete="off" placeholder="请输入手机号" autofocus="true"></el-input>
                </el-form-item>
                <el-form-item prop="password">
                    <el-input type="password" v-model="loginForm.password" auto-complete="off" placeholder="请输入密码"></el-input>
                </el-form-item>
                <div class="login-other">
                    <a :href="CENTER_ADDRESS+'/user/toRegister'" @click="$refs.loginForm.resetFields()" target="_blank" class="reg-link">免费注册</a>
                    <a :href="CENTER_ADDRESS+'/user/forgetPassword?flag=1'" @click="$refs.loginForm.resetFields()" target="_blank" class="forgot-pw">忘记密码</a>
                </div>
                <el-form-item>
